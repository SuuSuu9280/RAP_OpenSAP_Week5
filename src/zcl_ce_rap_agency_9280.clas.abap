CLASS zcl_ce_rap_agency_9280 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zrap_9280z_travel_agency_es5-agencyid.
    TYPES t_business_data TYPE TABLE OF zrap_9280z_travel_agency_es5.
...
CLASS ZCL_CE_RAP_AGENCY_9280 IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_9280' ).
